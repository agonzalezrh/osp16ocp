...
# BlockStorage will be replaced by 'controller', 'blockstorage',
# 'cephstorage' and all the deployed roles.

if hiera('step') >= 4 {
  hiera_include('BlockStorage_classes', [])
}

$package_manifest_name = join(['/var/lib/tripleo/installed-packages/overcloud_BlockStorage', hiera('step')])
